...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Priangshu Mukherjee";
...
var typed = new Typed(".typing-text", {
    strings: ["Python Development", "Artificial Intelligence", "Machine Learning", "Cyber Security", "Full Stack Development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
(function () {
    ...
    s1.async = true;
    s1.src = 'https://embed.tawk.to/681341b5e2e0e9190b0187ed/1iq5jhc8l';
    s1.charset = 'UTF-8';
